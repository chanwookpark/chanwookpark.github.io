---
layout: post
title:  "Zuul 2 : The Netflix Journey to Asynchronous, Non-Blocking Systems(번역)"
date:   2016-11-15 01:00:00 +0000
...
> 추가로 Blocking은 '블록킹'으로 Non-Blocking은 '논-블록킹'으로 번역하였습니다.
...
# 블록킹과 논-블록킹 시스템 간의 차이 (Differences Between Blocking vs. Non-Blocking Systems)
...
![Multithreaded System Architecture](/images/netflix/zuul2-journey/sD7ncrJznpx4S284ScYifrA.png)
...
![Asynchronous and Non-blocking System Architecture](/images/netflix/zuul2-journey/smX2GaYGfJuuIl9UHlh5ceA.png)
...
# 논-블록킹 Zuul 만들기 (Building Non-Blocking Zuul)
...
# 운영에서 Zuul 2 적용 결과 (Results of Zuul 2 in Production)
...
- 클라우드 게이트웨이 팀 (Mikey Cohen, Mike Smith, Susheel Aroskar, Arthur Gonigberg, Gayathri Varadarajan, Sudheer Vinukonda)
